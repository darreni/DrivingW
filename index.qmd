...
drivingAutosome1weak = Chrom("1", driveStrengthWeak, 0.0, 0.0)
```
...
**pop1C** has 5% driving W (of the strong variety):
...
pop1C = Population(pop1CFemales, pop1CMales)
```
...
**pop2B** has 5% driving Z of the weak variety. Here we set the proportions of males with different kinds of Z by assuming Hardy-Weinberg equilibrium:
...
pop2B = Population(pop2BFemales, pop2BMales)
```

**pop2C** has 5% driving Z of the strong variety. Here we set the proportions of males with different kinds of Z by assuming Hardy-Weinberg equilibrium:
...
pop2C = Population(pop2CFemales, pop2CMales)
```
...
**pop3B** has 5% driving autosome (A) of the weak variety. We again use HW equilibrium for the initial setup of the frequencies of different individual types:
...
pop3B = Population(pop3BFemales, pop3BMales)
```

**pop3C** has 5% driving autosome (A) of the strong variety. We again use HW equilibrium for the initial setup of the frequencies of different individual types:
...
pop3C = Population(pop3CFemales, pop3CMales)
```
...
```{julia}
pop1Brun = runManyGens(pop1B, runLength, driveCost = 0.0)
...
xlims!(0, runLength)
ylims!(0, 1.05)
plot!(0:runLength, pop1Brun.propDrivingW, color = :red, label = "Driving W")
```

```{julia}
pop1Crun = runManyGens(pop1C, runLength, driveCost = 0.0)
...
xlims!(0, runLength)
ylims!(0, 1.05)
plot!(0:runLength, pop1Crun.propDrivingW, color = :red, label = "Driving W")
```
...
```{julia}
pop2Brun = runManyGens(pop2B, runLength, driveCost = 0.0)
...
xlims!(0,runLength)
ylims!(0, 1.05)
plot!(0:runLength, pop2Brun.propDrivingZ, color = :blue, label = "Driving Z")
```

```{julia}
pop2Crun = runManyGens(pop2C, runLength, driveCost = 0.0)
...
xlims!(0,runLength)
ylims!(0, 1.05)
plot!(0:runLength, pop2Crun.propDrivingZ, color = :blue, label = "Driving Z")
```
...
```{julia}
pop3Brun = runManyGens(pop3B, runLength, driveCost = 0.0)
...
xlims!(0, runLength)
ylims!(0, 1.05)
plot!(0:runLength, pop3Brun.propDrivingA, color = :green, label = "Driving autosome")
```

```{julia}
pop3Crun = runManyGens(pop3C, runLength, driveCost = 0.0)
...
xlims!(0, runLength)
ylims!(0, 1.05)
plot!(0:runLength, pop3Crun.propDrivingA, color = :green, label = "Driving autosome")
```
...
#### Combine some of above for Fig. 2 of bioRxiv version of paper
...
#### Combine some of above for Fig. 2 of new version of paper
